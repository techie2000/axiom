...
type Services struct {
	...
	RegistrationAuthority  RegistrationAuthorityService
}

// NewServices creates a new services instance
func NewServices(repos *repository.Repositories, db *gorm.DB, leiDataDir string, masterDataDir string, jwtSecret string, jwtExpiry time.Duration, gleifRAListURL string) *Services {
	return &Services{
		...
		RegistrationAuthority: NewRegistrationAuthorityService(repos.RegistrationAuthority, gleifRAListURL),
	}
}
