...
func (r *stubRARepo) FindAll(_ int, _ int) ([]*domain.GLEIFRegistrationAuthority, error) { return r.upserted, nil }
func (r *stubRARepo) FindByRAID(_ string) (*domain.GLEIFRegistrationAuthority, error)    { return nil, nil }
...
func (r *stubELFRepo) FindAll(_ int, _ int) ([]*domain.GLEIFEntityLegalForm, error) { return r.upserted, nil }
...
func (r *stubRoleRepo) FindAll(_ int, _ int) ([]*domain.GLEIFOrganizationalRole, error) { return r.upserted, nil }
func (r *stubRoleRepo) FindByRoleCode(_ string) (*domain.GLEIFOrganizationalRole, error) { return nil, nil }
...
func (r *stubJurRepo) FindAll(_ int, _ int) ([]*domain.GLEIFLegalJurisdiction, error) { return r.upserted, nil }
