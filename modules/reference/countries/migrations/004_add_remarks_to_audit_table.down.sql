-- Migration: 004_add_remarks_to_audit_table.down.sql
-- Rollback migration 004

-- Restore the audit trigger function to previous version (without remarks)
...
-- Drop remarks column from audit table
